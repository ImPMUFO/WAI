...
const fa = {
  ...
  lastMap: 'آخرین نقشه',
  saveName: 'ذخیره نام',
  authHint: 'بعد از ثبت\u200cنام، یک ایمیل تأیید برایت ارسال می\u200cشود. باید روی لینک داخل آن ایمیل بزنی تا ایمیلت تأیید شود و حسابت فعال گردد. بعد می\u200cتوانی وارد شوی.',
  loggedInAs: 'وارد شده\u200cای',
  missions: 'بازی\u200cها و مأموریت\u200cها',
  dailyQuizMission: 'مأموریت روزانه: ۱ بازی',
  dailyChatMission: 'مأموریت روزانه: گفتگو',
  levelWord: 'سطح',
  xpWord: 'امتیاز',
}
...
const en: typeof fa = {
  ...
  lastMap: 'Last map',
  saveName: 'Save name',
  authHint: 'After sign-up, you get a confirmation email. Open the link to verify your email and activate your account, then log in.',
  loggedInAs: 'Signed in as',
  missions: 'Games & missions',
  dailyQuizMission: 'Daily mission: 1 game',
  dailyChatMission: 'Daily mission: chat',
  levelWord: 'Level',
  xpWord: 'XP',
}
...
const ar: typeof fa = {
  ...
  lastMap: 'آخر خريطة',
  saveName: 'حفظ الاسم',
  authHint: 'بعد التسجيل يصلك بريد تأكيد. افتح الرابط لتفعيل حسابك ثم سجّل الدخول.',
  loggedInAs: 'مسجّل الدخول',
  missions: 'الألعاب والمهام',
  dailyQuizMission: 'مهمة يومية: لعبة واحدةحدة',
  dailyChatMission: 'مهمة يومية: حوار',
  levelWord: 'المستوى',
  xpWord: 'نقاط',
}
